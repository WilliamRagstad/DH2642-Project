    ...
    return (
        <div>
            ...
            <form onSubmit={e => {
                ...
                <input type="email" name={'email'} value={loginFormData.email} onInput={e => loginChange((e.target as HTMLInputElement).name, (e.target as HTMLInputElement).value)} placeholder="E-mail"></input>
