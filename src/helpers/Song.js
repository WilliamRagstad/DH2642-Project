...
class Song {
    ...
    constructor(res, key, partial = false, config = {}) {
         ...
         * @type {?Artist}
         */
        this.artist = new Artist(res.primary_artist, key, true); // Throws error sooo directly require
    ...
    lyrics(removeChorus = false) {
        ...
        return new Promise((resolve, reject) => {
            ...
            axios.get(`https://cors-anywhere.herokuapp.com/` + this.url, this.config.requestOptions)
                .then(async res => {
    ...
    fetch() {
        ...
        return new Promise((resolve, reject) => {
            axios.get(`https://cors-anywhere.herokuapp.com/${CONSTANTS.BASE_URL}/songs/${this.id}`, {
