...
class Artist {
    ...
    songs(options = {}) {
        ...
        return new Promise((resolve, reject) => {
            axios.get(`https://cors-anywhere.herokuapp.com/${CONSTANTS.BASE_URL}/artists/${this.id}/songs?page=${page}&per_page=${per_page}&sort=${sort}`, {
    ...
    fetch() {
        ...
        return new Promise((resolve, reject) => {
            axios.get(`${CONSTANTS.BASE_URL}/artists/${this.id}`, {
                ...this.config.requestOptions,
                headers: {
                    'Authorization': `Bearer ${this.key}`
                }
